...
To update *DDD and Microservices: The Atlas*:

1. In the book repo (`dddms`), run `scripts/check.sh` and `scripts/build.sh`, then start `python3 scripts/render-server.py`
